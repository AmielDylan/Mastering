...
import {NotAvailable, Untranslatable, BatchIsEmpty, QualityThresholdNotMet} from "./errors";
...
export class TranslationService {
  ...
  premium(text, minimumQuality) {
    ...
    return qualityCall().catch((error)=>{
      if(error instanceof NotAvailable){
      ...
      return qualityCall().catch((error) => {throw error})
    })
  }
}
